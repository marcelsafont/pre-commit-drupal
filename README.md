...
2. crear fitxer pre-commit dins la carpeta ./git/hooks i enganxar el contingut o copiar el fitxer del repositori clonat i enganxar dins la carpeta ./git/hooks
